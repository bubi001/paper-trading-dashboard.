...
if not ledger_df.empty:
    ...
    # Process ALL trades directly from sheet (including LIQUIDCASE)
...
# Compute live prices & P&L for all positions
...
is_lc_row = holdings["Ticker"].astype(str).str.upper().str.contains("LIQUIDCASE")
